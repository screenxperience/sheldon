						...
						if($_GET['category'] == $allowed_category[0])
						{
							...
							else
							{
								if(preg_match('/[^a-z]/',$_GET['tab']) == 0)
								{
									...
									{
										$query = sprintf("
										SELECT asset_description,asset_locked
										FROM asset
										WHERE asset_id = '%s';",
										...
										if($row = $result->fetch_array(MYSQLI_ASSOC))
										{
											...
											$output .= '<p><textarea id="assetdescription" onkeyup="'."chk_inputlength('assetdescription',200)".';" class="input-default border border-grey focus-border-light-blue" name="attr_value">'.$asset_description.'</textarea></p>';
											...
											$output .= '<div class="panel black-alpha">';
											$output .= '<h2>Aktionen</h2>';
											$output .= '<p><a href="del.php?category='.$_GET['category'].'&id='.$_GET['id'].'" class="btn-default border border-red red hover-white hover-text-red">l&ouml;schen <i class="fas fa-trash"></i></a> ';
											
											if($asset_locked)
											{
												$output .= '<a href="change.php?category='.$_GET['category'].'&id='.$_GET['id'].'&attr=locked&attr_value=0&returnto='.urlencode('http://'.$_SERVER['HTTP_HOST'].'/view.php?category='.$_GET['category'].'&id='.$_GET['id'].'&tab='.$_GET['tab']).'" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">entsperren <i class="fas fa-lock-open"></i></a> ';
											}
											else
											{
												$output .= '<a href="change.php?category='.$_GET['category'].'&id='.$_GET['id'].'&attr=locked&attr_value=1&returnto='.urlencode('http://'.$_SERVER['HTTP_HOST'].'/view.php?category='.$_GET['category'].'&id='.$_GET['id'].'&tab='.$_GET['tab']).'" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">sperren <i class="fas fa-lock"></i></a> ';
											}
											
											$output .= '<a href="cart.php?aktion=add&category='.$_GET['category'].'&id='.$_GET['id'].'" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">in den Warenkorb <i class="fas fa-shopping-cart"></i> <i class="fas fa-plus"></i></a>';
											$output .= '</p>';
											$output .= '</div>';
										}
										else
								...
								if(preg_match('/[^a-z]/',$_GET['tab']) == 0)
								{
									...
									if(in_array($_GET['tab'],$allowed_tabs))
									{
										...
										if($row = $result->fetch_array(MYSQLI_ASSOC))
										{
											...
											$output .= '<div class="panel black-alpha">';
											$output .= '<h2>Aktionen</h2>';
											$output .= '<p><a href="del.php?category='.$_GET['category'].'&id='.$_GET['id'].'&returnto='.urlencode('http://'.$_SERVER['HTTP_HOST'].'/list.php?category='.$_GET['category'].'&site=0&amount=5').'" class="btn-default border border-red red hover-white hover-text-red">l&ouml;schen <i class="fas fa-trash"></i></a> ';
											
											if($user_active)
											{
												$output .= '<a href="change.php?category='.$_GET['category'].'&id='.$_GET['id'].'&attr=active&attr_value=0" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">deaktivieren <i class="fas fa-times"></i></a> ';
											}
											else
											{
												$output .= '<a href="change.php?category='.$_GET['category'].'&id='.$_GET['id'].'&attr=active&attr_value=1" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">aktivieren <i class="fas fa-check"></i></a> ';
											}

											if($user_admin)
											{
												$output .= '<a href="change.php?category='.$_GET['category'].'&id='.$_GET['id'].'&attr=admin&attr_value=0" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">herabstufen <i class="fas fa-arrow-down"></i></a> ';
											}
											else
											{
												$output .= '<a href="change.php?category='.$_GET['category'].'&id='.$_GET['id'].'&attr=admin&attr_value=1" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">heraufstufen <i class="fas fa-arrow-up"></i></a> ';
											}

											$output .= '<a href="cart.php?aktion=add&category='.$_GET['category'].'&id='.$_GET['id'].'" class="btn-default border border-light-blue light-blue hover-white hover-text-blue">in den Warenkorb <i class="fas fa-shopping-cart"></i> <i class="fas fa-plus"></i></a></p>';
											$output .= '</div>';
